...
const CONFIG = {
    ...
    MUTATION_CHANCE: 0.5,
    CREATURE_SEX_RATIO_MALE: 0.5,
    CREATURE_MATE_MIN_ENERGY: 400,
    CREATURE_MATE_COST_MALE: 100,
    CREATURE_MATE_COST_FEMALE: 200,
    CREATURE_MATE_COOLDOWN_UPDATES: 30,
    EGG_HATCH_UPDATES: 30,
    CREATURE_MATE_STEER_STRENGTH: 0.7,

    FOOD_MAX_COUNT: 30,    
    FOOD_ENERGY: 500,   
    TOP_PERFORMERS_COUNT: 5,
    POPULATION_RESTART_THRESHOLD: 10,
