...
const CONFIG = {
    ...
    CREATURE_COLLISION_UPDATES_TO_FLASH: 4,
    CREATURE_VISIBILITY_RADIUS: 10,
    CREATURE_INTERACTION_RADIUS: 0.9,
    CREATURE_MATING_RADIUS: 1.2,
    CREATURE_MATE_INTENT_THRESHOLD: 0.6,
    CREATURE_MIN_ENERGY_TO_MATE: 300,
    CREATURE_MATE_COST_MALE: 220,
    CREATURE_MATE_COST_FEMALE: 300,
    CREATURE_MATING_COOLDOWN: 1000 * 8,
    CREATURE_MAX_SPEED: 0.4,
    CREATURE_MAX_TURN_ANGLE_RAD: 45 / 180 * Math.PI,
    CREATURE_PATH_LENGTH: 5,

    EGG_INCUBATION_DURATION: 1000 * 6,
    WORLD_MAX_EGGS: 30,

    FOOD_MAX_COUNT: 30,    
    FOOD_ENERGY: 130,   
    FOOD_ENERGY_BONUS: 130,
    FOOD_ENERGY_BONUS_MAX_GEN: 100,
